...
print("GOAL: Analysing zips from removals from 'Hams.txt' ...")
...
f=open("Hams.txt",'r')
for lyne in f:
    removals.append(lyne[:-1])

holdZips=set()
for e in removals:
    holdZips.add(zipcode[e])
...
for e in L:
    hold=findLL(e)
    ZipLocs.append([e,hold[0],hold[1]])
...
print("Raw List:")
print(L)
print("Zips with Lat Lon:")
print(ZipLocs)
print("Only the unique Lat/Lons:")
print(ZipLocs2)
